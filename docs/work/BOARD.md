...
- **TASK-05** tiers + frozen window (I13) — opus — **sequential (no parallel)** — _in-review (PR open from `task/tiers-frozen-window`)_
...
| 05 | Tiers + frozen window (I13) | **in-review** | opus | models/bespoke.py, models/tiers.py | **no (core)** | 01 |
